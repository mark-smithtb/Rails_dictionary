...
class DefinitionTest < ActiveSupport::TestCase
  ...
  test "Definition who's word length is 16 or more should be considered fancy" do
    definition = Definition.create(word: 'accountabilities', meaning: 'Education. a policy of holding schools and teachers accountable for students academic progress by linking such progress with funding for salaries, maintenance, etc.')
    assert definition.fancy?, "A 16 letter word should be fancy."
  end
  test "Definitions who's word length is less that 16 should not be considered fancy" do
